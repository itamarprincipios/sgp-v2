...
<div class="space-y-1">
    ...
    @elseif($role === 'semed')
        ...
        <a href="/semed/cadastros" class="flex items-center gap-3 px-4 py-2.5 text-sm font-medium rounded-lg transition duration-150 {{ request()->is('semed/cadastros*') ? 'bg-indigo-600 text-white shadow-md shadow-indigo-600/10' : 'text-slate-400 hover:text-slate-200 hover:bg-slate-800/50' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
