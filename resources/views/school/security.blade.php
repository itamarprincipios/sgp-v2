<x-app-layout>
    ...
    <div class="max-w-lg mx-auto space-y-6">
        ...
        <div class="bg-white border border-slate-200 rounded-2xl shadow-sm p-6">
            <h3 class="font-bold text-slate-900 text-sm mb-1">Alterar Minha Senha</h3>
            <p class="text-xs text-slate-500 mb-5">
                Seu acesso foi criado com uma senha temporária. Defina agora uma senha forte e exclusiva.
            </p>
            ...
            <form action="{{ route('school.password.change') }}" method="POST" class="space-y-4">
                ...
                <button type="submit" class="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-xl text-xs shadow-sm transition">
                    Salvar Nova Senha
                </button>
            </form>
        </div>
