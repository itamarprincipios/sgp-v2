    ...
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
            <div class="p-6 border-b border-slate-100 bg-slate-50/50">
                ...
                <p class="text-xs text-slate-500">O(a) diretor(a) terá acesso apenas à escola selecionada abaixo.</p>
            </div>

            <form action="{{ route('semed.directors.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
                ...
                <div class="p-3 bg-indigo-50 border border-indigo-100 rounded-lg text-indigo-800 text-xs flex items-start gap-2">
                    ...
                    <span>
                        Uma senha temporária será gerada automaticamente e exibida apenas uma vez após o cadastro. Oriente o(a) diretor(a) a trocá-la no primeiro acesso.
                    </span>
                </div>
