                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="billing_type" id="billing_type" class="w-full rounded-lg border-slate-200 focus:border-violet-500 focus:ring focus:ring-violet-500/20 text-sm py-2.5 transition @error('billing_type') border-rose-500 focus:border-rose-500 focus:ring-rose-500/20 @enderror">
                            <option value="" {{ old('billing_type') === null ? 'selected' : '' }}></option>
                            <option value="mensal" {{ old('billing_type') === 'mensal' ? 'selected' : '' }}>Mensal</option>
                            <option value="vitalicio" {{ old('billing_type') === 'vitalicio' ? 'selected' : '' }}>Vitalício</option>
                        </select>
                        @error('billing_type')
                            <p class="text-xs text-rose-600 mt-1.5 font-medium">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="number" name="ai_monthly_limit" id="ai_monthly_limit" min="1" value="{{ old('ai_monthly_limit') }}" placeholder="vazio = ilimitado" class="w-full rounded-lg border-slate-200 focus:border-violet-500 focus:ring focus:ring-violet-500/20 text-sm py-2.5 transition @error('ai_monthly_limit') border-rose-500 focus:border-rose-500 focus:ring-rose-500/20 @enderror">
