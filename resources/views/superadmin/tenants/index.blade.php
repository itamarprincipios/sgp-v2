                        ...
                        @forelse($tenants as $tenant)
                            <tr class="hover:bg-slate-50/40 transition duration-100">
                                ...
                                <td class="px-6 py-4 text-right space-x-2">
                                    ...
                                    <a href="{{ route('superadmin.tenants.ianne', $tenant) }}" class="inline-flex items-center px-3 py-1.5 border border-violet-200 rounded-lg text-xs font-semibold text-violet-700 bg-white hover:bg-violet-50 transition duration-150" title="Personalizar os prompts da IANNE deste município">
                                        <svg class="w-3.5 h-3.5 text-violet-500 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
